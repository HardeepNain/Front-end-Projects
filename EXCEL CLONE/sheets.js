...
function switchSheet(currentSheet) {
    ...
    //     allCells[lastCellIndex].textContent = dbRow[j].value; // allCells ke array me total 2600 div pde hai to hmare loop ke sturcture ki wajah se suru ke 26 object first 26 div se map honge and continue hoga same way me
    //     lastCellIndex++;
    //   }
    // }
